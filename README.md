...
Coffee Hunter is a navigation app to find nearby coffee shops in user's area, created by using Flutter. It uses open source
libraries like firebase_core, firebase_aut, cloud_firestore, geolocator, google_maps_flutter.


Youtube Video URL:
https://youtu.be/bKUlHQIAVx4
...
This is an application meant to make locating the nearby coffee shops easier. Also it does work like a social media
platform for the coffee shop visitors since they can make comments and interact with the application and other users. Our 
first aim is to make more people socialize by using our app to find new coffee shops to discover and experience.
Versions used:
