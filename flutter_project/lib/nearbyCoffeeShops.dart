...
class NearbyCoffeeShops extends StatefulWidget {
   NearbyCoffeeShops({Key? key,this.email,this.userName}) : super(key: key);
final email;
var userName;
  @override
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(onPressed: () async {
        ...
        markers.add(Marker(markerId: MarkerId("Starbucks"),
            ...
            onTap:(){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>CoffeeShopPage(doc: "WJWNDfqF1GD1BZrpQXrX",email: widget.email,userName: widget.userName,)));
            }));
        markers.add(Marker(markerId: MarkerId("Goche's Coffee"),
            ...
            onTap:(){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>CoffeeShopPage(doc: "jEyURoKz3UAariLg08eS",email: widget.email,userName: widget.userName)));
            }));
        markers.add(Marker(markerId: MarkerId("Las Habitas"),
            ...
            onTap:(){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>CoffeeShopPage(doc: "Ery4VcdOJVGd0FXXoOz0",email: widget.email,userName: widget.userName)));
            }));
        markers.add(Marker(markerId: MarkerId("The Leaf Coffee Shop"),
            ...
            onTap:(){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>CoffeeShopPage(doc: "dWGdLd8aalvq0JHh7Nfr",email: widget.email,userName: widget.userName)));
            }));
        markers.add(Marker(markerId: MarkerId("Espello Coffee House"),
            ...
            onTap:(){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>CoffeeShopPage(doc: "G1u08vHJI9MCzo9fan4n",email: widget.email,userName: widget.userName)));
            }));
        markers.add(Marker(markerId: MarkerId("ingo coffee"),
            ...
            onTap:(){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>CoffeeShopPage(doc: "e3qv2D8EMeM5izSNnNiU",email: widget.email,userName: widget.userName)));
            }));
        markers.add(Marker(markerId: MarkerId("The Optimist Co."),
            ...
            onTap:(){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>CoffeeShopPage(doc: "jzhvINy9mCdYpXL2KxES",email: widget.email,userName: widget.userName)));
            }));
        markers.add(Marker(markerId: MarkerId("Tuck Coffee x Etc"),
            ...
            onTap:(){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>CoffeeShopPage(doc: "szskXiFVk9Skzkp81Nwl",email: widget.email,userName: widget.userName)));
            }));
        markers.add(Marker(markerId: MarkerId("Waldo Coffee Co."),
            ...
            onTap:(){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>CoffeeShopPage(doc: "vJbOjfP2lBLOsttqC6pW",email: widget.email,userName: widget.userName)));
            }));
        markers.add(Marker(markerId: MarkerId("Kelvin Photo'n Coffee"),
            ...
            onTap:(){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>CoffeeShopPage(doc: "wa4dC4p8Cway3fA1tInM",email: widget.email,userName: widget.userName)));
            }));
        setState(() {
        });
      },
