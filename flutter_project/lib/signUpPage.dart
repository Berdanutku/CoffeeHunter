                ...
                if(formKey.currentState!.validate()){
                  ...
                  if(userName!=null&&passWord!=null&&eMail!=null&&rePass!=null&&age!=null&&gender!=null&&passWord==rePass){
                    ...
                    try{
                      ...
                      await data.set(json);
                      final data2=fireStore.collection("Users").doc(eMail).collection("Favourites").doc(eMail);
                      final json2={
                        "Name":[],
                        "Id":[]
                      };
                      await data2.set(json2);
                    }
                    catch(e){
                      print("Error");
                    }
                    formKey.currentState!.reset();
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>loginPage(userName: userName,)));
                  }
                  else{
